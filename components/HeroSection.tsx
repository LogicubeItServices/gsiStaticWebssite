...
const HeroSection = () => {
  return (
    <div className='w-full h-full relative bg-white'>
        ...
        <div className='absolute w-fit h-fit top-32 left-32  backdrop-blur-lg p-8 rounded-lg m-auto z-30 max-xl:left-20'>
          <Image src={LOGO} alt='logo' width={1000} height={1000} className='w-[30rem]'/>
        </div>
        <ImageCarousel/>
